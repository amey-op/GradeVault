...
const api = {
    ...
    createCourse: (semId, data) => axios.post(`${API_URL}/semesters/${semId}/courses/`, data),
    updateCourse: (id, data) => axios.put(`${API_URL}/courses/${id}`, data),
    deleteCourse: (id) => axios.delete(`${API_URL}/courses/${id}`),
    createAssessment: (courseId, data) => axios.post(`${API_URL}/courses/${courseId}/assessments/`, data),
    updateAssessment: (id, data) => axios.put(`${API_URL}/assessments/${id}`, data),
    deleteAssessment: (id) => axios.delete(`${API_URL}/assessments/${id}`),
